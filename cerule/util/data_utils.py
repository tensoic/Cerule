...
from cerule.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
class LazySupervisedDataset(Dataset):
    ...
    if data_dict is None:
        # Handle the case when data_dict is None
        print(f"Warning: data_dict is None for index {i}")
        return None
