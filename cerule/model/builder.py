...
def load_pretrained_model(model_path, model_base, model_name, model_type, load_8bit=False, load_4bit=False,
    ...
    if 'lora' in model_name.lower() and model_base is not None:
        ...
        print('Loading Cerule from base model...')
        if model_type == 'gemma':
            tokenizer = AutoTokenizer.from_pretrained(model_base, use_fast=False, trust_remote_code=True)
            model = CeruleGemmaForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True,
        ...
        print('Loading additional Cerule weights...')
        ...
        if model_type == 'gemma':
            ...
            model = CeruleGemmaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
